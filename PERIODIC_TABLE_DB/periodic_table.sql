...
--
-- Name: elements unq_name; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: elements unq_symbol; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unq_symbol UNIQUE (symbol);
